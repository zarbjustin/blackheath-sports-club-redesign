...
- Recorded media provenance, visual direction and replacement guidance in
  `docs/media-sources.md`.
- Replaced the generic Rugby concept with a close crop of an existing Blackheath Age
