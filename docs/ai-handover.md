...
- A separate proposed logo pack lives in `src/assets/brand/refined/`, with rationale in `docs/logo-refinement.md`. It is deliberately **not imported by the website** and must not replace the approved production crest without stakeholder approval.
