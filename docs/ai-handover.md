...
The generated homepage concept image has been replaced by six approved wide photographs: cricket,
daytime rugby and floodlit rugby at Rectory Field, a shared cricket-and-lawn-tennis view, the
...
- Production D1: `blackheath-sports-club-hours`
- Preview D1: `blackheath-sports-club-hours-preview`
- Pages binding: `OPENING_HOURS_DB` in production and preview
- Access application: `Blackheath Sports Club Hours Admin`
- Allowed administrator: `justin.zarb@zarb.co.uk`
...
- Interim generated imagery may be used to improve sports-card resolution and consistency, but it must be recorded as generated media and must not be described as Blackheath players or Rectory Field. The Rugby card is the exception: it uses a close crop of the approved `gallery-rugby-cinderford.webp` Blackheath Age Grade Rugby photograph. Replace generated cards with approved, high-resolution club action photography when supplied.
