...
- Real club photography optimised to WebP; the responsive homepage hero rotates between cricket,
  rugby, a shared cricket-and-lawn-tennis view, the summer clubhouse and golden hour at Rectory
  Field, with pause/play controls and a blur-up placeholder; custom per-sport SVG icons.
