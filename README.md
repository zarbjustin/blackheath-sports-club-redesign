...
- A rotating set of real Rectory Field hero images (cricket, daytime and floodlit rugby,
  the shared multi-sport ground, summer clubhouse and golden hour), with responsive WebP
  derivatives generated by `npm run optimize:hero`. The `lightOrder` value on each entry in
  `src/main.jsx` controls the bright-day-to-night sequence.
...
- More real photography and video of Rectory Field, clubhouse interiors, match days and juniors.
